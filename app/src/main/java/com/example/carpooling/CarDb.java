...
public class CarDb extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_NAME +" (ID INTEGER PRIMARY KEY AUTOINCREMENT,LOCATION TEXT,DESTINATION TEXT,CODE TEXT)");
    }
    ...
    public boolean insertData(String location,String destination,String code) {
    ...
    public Integer deleteride(String id){
